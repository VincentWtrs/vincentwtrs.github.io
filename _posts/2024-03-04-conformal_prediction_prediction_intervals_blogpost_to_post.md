...
# Sources
* Romano, Patterson & Candes (2019): Conformalized Quantile Regression (https://arxiv.org/abs/1905.03222)
* Valemans _Awesome Conformal Prediction_ GitHub page https://github.com/valeman/awesome-conformal-prediction
...
for tau in [0.3, 0.5, 0.9]:
    ...
    plt.plot(pred, pinball_loss, alpha=0.9, label=f"Quantile: {tau}");
    plt.legend();
